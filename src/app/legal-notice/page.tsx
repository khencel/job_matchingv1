export default function LegalNotice() {
    return (
        <div className="legal-notice-container" style={{ padding: "2rem", maxWidth: "800px", margin: "0 auto", fontFamily: "Arial, sans-serif" }}>
            <h1 style={{ textAlign: "center", marginBottom: "1.5rem" }}>Legal Notice</h1>
            <section>
