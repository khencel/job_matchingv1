...
export default function JobListing() {
    ...
    const btnDelete = async (id: number) => {
        ...
        showSuccessToast(t("toast.deleteTitle"), t("toast.deleteSuccess"));
    }
    ...
    const handleChangeStatus = async (id:number) =>{
        ...
        onConfirm:async () => {
                ...
                dispatch(listJobPost({ userId, page: currentPage, pageSize }));
            showSuccessToast(t("toast.statusTitle"), t("toast.statusSuccess"))
            }
        })
                                    ...
                                    {items.map((item: any) => (
                                        <tr key={item.id}>
                                            <td className={item.is_active?"text-success":"text-danger"}>
                                                {item.is_active ? t("status.enabled") : t("status.disabled")}
                                            ...
                                            <td>
                                                <div className="dropdown">
                                                    ...
                                                    <ul className="dropdown-menu dropdown-menu-end">
                                                        <li>
                                                            <button className="dropdown-item" onClick={() => handleEdit(item)}>{t("actions.edit")}</button>
                                                        </li>
                                                        <li>
                                                            <button className="dropdown-item text-danger" onClick={() => handleDelete(item.id)}>{t("actions.delete")}</button>
                                                        </li>
                                                        <li>
                                                            <button 
