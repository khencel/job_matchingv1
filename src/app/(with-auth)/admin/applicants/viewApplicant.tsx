...
export default function ViewApplicant({
  ...
  return (
    <Modal show={handleShow} onHide={handleClose} size="xl">
      ...
      <Modal.Body>
        <div className="row">
          <div className="col-2 p-3">
            <div
              className="applicant_avatar text-center"
              style={{
                backgroundImage: `url('${process.env.NEXT_PUBLIC_API_CONTENT_URL}${data?.user?.avatar || "/media/placeholder.jpg"}')`,
                width: "100px",
                height: "100px",
          ...
          <div className="col-md-7">
            <div className="row mt-5">
              <div className="col">
                ...
                cum velit excepturi modi impedit nam distinctio voluptates totam
                at quidem, nulla temporibus aperiam, exercitationem obcaecati
                labore molestiae corporis tempora? Nam!
              </div>
            </div>
              ...
              <div className="col-6">
                <div>
                  ...
                  <small>
                    ...
                    <br />
                    <strong>
                      <FormattedDate date={userdata?.birthdate} />
                    </strong>
                  </small>
                </div>
                ...
                <div className="row mt-3">
                  ...
                  <div className="col-9">
                    <small>
                      {t("location")}
                      <br />
                      <strong>{userdata?.currentPlaceResidence}</strong>
                    </small>
                  </div>
                </div>
                <div className="row mt-3">
                  ...
                  <div className="col-9">
                    <small>
                      {t("telephone")}
                      <br />
                      <strong>{userdata?.contactNo}</strong>
                    </small>
                  </div>
                </div>
                <div className="row mt-3">
                  ...
                  <div className="col-9">
                    <small>
                      {t("email")}
                      <br />
                      <strong>{data?.user?.email || "No email"}</strong>
                    </small>
                  </div>
                </div>
                <div className="row mt-3">
                  ...
                  <div className="col-9">
                    <small>
                      {t("facebook")}
                      <br />
                      <strong>{userdata?.facebook || "No facebook"}</strong>
                    </small>
                  </div>
                </div>
              </div>
