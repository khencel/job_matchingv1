...
export default function FilterModal({handleShow, handleClose, companyList, onApplyFilter}: FilterModalProps){
    const t = useTranslations("adminApplicantsFilterModal");
        ...
        <>
            <Modal show={handleShow} onHide={handleClose}>
                ...
                <Modal.Body>
                    <div className="row">
                        <div className="col">
                            ...
                            >
                                <option value="" disabled  hidden>{t("selectCompany")}</option>
                    ...
                    <div className="row mt-3">
                        <div className="col">
                            ...
                            >
                                <option value="" disabled hidden>{t("selectGender")}</option>
                                <option value="">{t("none")}</option>
                        ...
                        <div className="col">
                            ...
                            >
                                <option value="" disabled hidden>{t("selectStatus")}</option>
                                <option value="">{t("none")}</option>
                    ...
                    <div className="row mt-3">
                        <div className="col">
                            <strong>{t("startAgeAbove")}</strong>
                            <br />
                            <input type="number" value={startAge} onChange={(e) => setStartAge(Number(e.target.value))} className='form-control' placeholder={t("startAgePlaceholder")} />
                ...
                <Button variant="secondary" onClick={handleClose}>
                    ...
                    <AddButton label={t("applyFilter")} onClick={handleApply} className='btn btn-primary-custom rounded-3' icon={null} /> 
                </Modal.Footer>
            </Modal>
        </>
    )
