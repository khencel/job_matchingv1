...
const ResumeForm = () => {
  const t = useTranslations("jobSeekerResumeForm");
  ...
  >(
    () => ({
      fullName: (value) => (value.trim() ? null : t("validation.fullNameRequired")),
      gender: (value) => (value.trim() ? null : t("validation.genderRequired")),
      email: (value) =>
        /\S+@\S+\.\S+/.test(value) ? null : t("validation.emailInvalid"),
      phone: (value) =>
        value.trim().length >= 7 ? null : t("validation.phoneTooShort"),
      address: (value) => (value.trim() ? null : t("validation.addressRequired")),
      birthdate: (value) => (value ? null : t("validation.birthdateRequired")),
      age: (value) => (Number(value) > 0 ? null : t("validation.ageRequired")),
      postalCode: (value) => (value.trim() ? null : t("validation.postalCodeRequired")),
      reasons: (value) => (value.trim() ? null : t("validation.reasonsRequired")),
      photoUrl: (value) => (value.trim() ? null : t("validation.photoRequired")),
    }),
    [t],
  );
  ...
  const handlePhotoUpload = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    if (!file.type.startsWith("image/")) {
      setUploadError(t("upload.invalidImage"));
      e.target.value = "";
      return;
    }
    const maxSizeMb = 2;
    if (file.size > maxSizeMb * 1024 * 1024) {
      setUploadError(t("upload.maxSize", { size: maxSizeMb }));
      e.target.value = "";
      return;
    }
    setUploadError(null);
  ...
  const clearPhoto = () => {
    ...
    setErrors((prev) => ({ ...prev, photoUrl: t("validation.photoRequired") }));
    ...
    <Card className="shadow-sm border-0 h-100">
      <Card.Header className="bg-white">
        <div className="d-flex align-items-center justify-content-between">
          <div>
            <Card.Title>{t("header.title")}</Card.Title>
        ...
        <Form noValidate>
          <section className="mb-4">
            ...
            <Form.Group className="mb-3" controlId="resume-fullName">
              <Form.Label>{t("fields.fullName")}</Form.Label>
              <Form.Control
                name="fullName"
            ...
            <Form.Group className="mb-3" controlId="resume-namePhonetic">
              <Form.Label>{t("fields.namePhonetic")}</Form.Label>
              <Form.Control
                name="namePhonetic"
            ...
            <Row className="g-3">
              <Col md={6}>
                <Form.Group controlId="resume-birthdate">
                  <Form.Label>{t("fields.birthdate")}</Form.Label>
                  <Form.Control
                    type="date"
                    name="birthdate"
              ...
              <Col md={6}>
                <Form.Group controlId="resume-age">
                  <Form.Label>{t("fields.age")}</Form.Label>
                  <Form.Control
                    type="number"
                    name="age"
                    min={0}
            ...
            <Row className="g-3 mt-1">
              <Col md={6}>
                <Form.Group controlId="resume-gender">
                  <Form.Label>{t("fields.gender")}</Form.Label>
                  <Form.Select
                    name="gender"
                  ...
                  >
                    ...
                    <option value="non-binary">{t("options.gender.nonBinary")}</option>
                    <option value="prefer-not">{t("options.gender.preferNot")}</option>
                  </Form.Select>
                  <Form.Control.Feedback type="invalid">
                    {errors.gender}
                  </Form.Control.Feedback>
              ...
              <Col md={6}>
                <Form.Group controlId="resume-photo">
                  <Form.Label>{t("fields.photo")}</Form.Label>
          ...
          <section className="mb-4">
            <h5 className="mb-3">{t("sections.contact")}</h5>
            ...
            <Form.Group className="mb-3" controlId="resume-addressPhonetic">
              <Form.Label>{t("fields.addressPhonetic")}</Form.Label>
              <Form.Control
            ...
            <Row className="g-3">
              ...
              <Col md={6}>
                <Form.Group controlId="resume-other-phone">
                  <Form.Label>{t("fields.otherPhone")}</Form.Label>
                  <Form.Control
            ...
            <Row className="g-3 mt-1">
              <Col md={6}>
                <Form.Group controlId="resume-other-email">
                  <Form.Label>{t("fields.otherEmail")}</Form.Label>
                  <Form.Control
              ...
              <Col md={6}>
                <Form.Group controlId="resume-other-phonetic">
                  <Form.Label>{t("fields.otherPhonetic")}</Form.Label>
                  <Form.Control
            ...
            <Form.Group className="mt-3" controlId="resume-other-address">
              <Form.Label>{t("fields.otherAddress")}</Form.Label>
              <Form.Control
                as="textarea"
                rows={2}
          ...
          <section className="mb-4">
            <div className="d-flex align-items-center justify-content-between mb-3">
              ...
              >
                <Plus size={14} className="me-1" /> {t("buttons.add")}
              </Button>
            </div>
              ...
              >
                <Card.Body>
                  <Row className="g-2">
                    <Col xs={4}>
                      <Form.Group controlId={`edu-year-${index}`}>
                        <Form.Label>{t("fields.year")}</Form.Label>
                        <Form.Control
                          value={entry.year}
                          onChange={(e) =>
                    ...
                    <Col xs={4}>
                      <Form.Group controlId={`edu-month-${index}`}>
                        <Form.Label>{t("fields.month")}</Form.Label>
                        <Form.Control
                          value={entry.month}
                          onChange={(e) =>
                  ...
                  <Form.Group className="mt-2" controlId={`edu-desc-${index}`}>
                    <Form.Label>{t("fields.details")}</Form.Label>
                    <Form.Control
                      as="textarea"
                      rows={2}
          ...
          <section className="mb-4">
            <div className="d-flex align-items-center justify-content-between mb-3">
              <h5 className="mb-0">{t("sections.work")}</h5>
            ...
            {licenseEntries.map((entry, index) => (
              <Card key={`license-${index}`} className="mb-3 border-0 bg-light">
                <Card.Body>
                  ...
                  >
                    <Form.Label>{t("fields.qualification")}</Form.Label>
                    <Form.Control
          ...
          <section>
            <h5 className="mb-3">{t("sections.reasons")}</h5>
            <Form.Group controlId="resume-reasons">
              <Form.Control
                ...
                onChange={handleInputChange}
                placeholder={t("placeholders.reasons")}
