...
export default function JobSeekerLayout({
  ...
  const t = useTranslations("jobSeekerLayout");
        ...
        <div className={`sidebar ${isCollapsed ? "collapsed" : ""}`}>
          ...
          <Nav className="flex-column">
            <Nav.Item>
              ...
              >
                <UserCircle /> {!isCollapsed && <span>{t("items.profile")}</span>}
              </Nav.Link>
            </Nav.Item>
            <Nav.Item>
              <Nav.Link
              ...
              >
                <FoldersIcon /> {!isCollapsed && <span>{t("items.appliedJobs")}</span>}
              </Nav.Link>
            </Nav.Item>
            <Nav.Item>
              <Nav.Link
              ...
              >
                <FileUserIcon /> {!isCollapsed && <span>{t("items.documents")}</span>}
              </Nav.Link>
            </Nav.Item>
            <Nav.Item>
              <Nav.Link
