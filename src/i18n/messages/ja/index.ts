...
import jobSeekerPages from "./jobSeekerPages.json";
import employerPages from "./employerPages.json";
import adminPages from "./adminPages.json";
import supervisoryPages from "./supervisoryPages.json";
import resumeTemplate from "./resumeTemplate.json";
import resumeForm from "./resumeForm.json";
import savedJobs from "./savedJobs.json";
import profileJobSeeker from "./profileJobSeeker.json";
import jobSeekerDashboard from "./jobSeekerDashboard.json";
import documentsPage from "./documentsPage.json";
...
import employerPostJob from "./employerPostJob.json";
