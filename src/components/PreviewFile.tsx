...
const PreviewFile = ({
  ...
  const resolvedFileName = fileName || t("title");
        ...
        return (
          <div className="d-flex align-items-center justify-content-center h-100">
            <img
              ...
              onError={() => setError(t("errors.image"))}
            />
          </div>
        );
        ...
        return (
          <div className="d-flex align-items-center justify-content-center h-100">
            <video
              ...
              onError={() => setError(t("errors.video"))}
            />
          </div>
        );
          ...
          <div className="p-4 h-100 bg-light overflow-auto">
            ...
            <div className="text-center py-5">
              ...
              <p className="text-muted">
                {t("document.type", { type: fileType.toUpperCase() })}
              </p>
            </div>
          </div>
        );
  ...
  return (
    ...
    >
      <Modal.Header className="bg-light border-bottom d-flex justify-content-between align-items-center">
        <Modal.Title className="text-truncate fw-bold">{resolvedFileName}</Modal.Title>
