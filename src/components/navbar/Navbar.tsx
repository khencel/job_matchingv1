      ...
      <div className="container d-flex align-items-center">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav mx-auto mb-2 mb-lg-0 d-flex flex-column flex-lg-row gap-2 gap-lg-3 text-center">
            ...
            <li className="nav-item"><Link className="nav-link" href="/#job_support_features">Features</Link></li>
            <li className="nav-item"><Link className="nav-link" href="/#about_us">About Us</Link></li>
            <li className="nav-item"><Link className="nav-link" href="/#q_and_a">Q&A</Link></li>
            <li className="nav-item"><Link className="nav-link" href="/#contact_us">Contacts</Link></li>
            <li className="nav-item">
              {user ? (
                  <Dropdown>
                    <Dropdown.Toggle variant="primary" id="dropdown-profile" className="p-0 bg-transparent border-0 dropdown-toggle-no-caret">
                  ...
                  <Link className="nav-link" href="/login">{t("signIn")}</Link>
                )}
            </li>
          </ul>
          ...
          <div className="d-flex align-items-center gap-2 ms-lg-3 mt-2 mt-lg-0">
            ...
            <select className="form-select form-select-sm" value={locale} onChange={handleLanguageChange} style={{ minWidth: "120px" }}>
