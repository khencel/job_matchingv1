...
export default function Navbar() {
  ...
  const { access } = useAppSelector((s) => s.authState);
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav mx-auto mb-3 mb-lg-0 d-flex flex-column flex-lg-row align-items-center gap-1 gap-lg-3 text-center">
            <li className="nav-item">
              <Link
                className="nav-link nav-link-modern px-3 py-2 rounded-pill"
                href="/"
              >
                {t("home")}
              </Link>
            ...
            <li className="nav-item">
              {access && user ? (
                <Dropdown align="end">
                  ...
                  <Dropdown.Menu
                    className="shadow-sm border-0 rounded-4 p-2"
                    style={{ minWidth: 220 }}
                  >
                    <DropdownNav />
                  </Dropdown.Menu>
